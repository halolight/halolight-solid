                  ...
                  <div class="flex space-x-3">
                    ...
                    <div class="flex-1 min-w-0">
                      <div class="flex items-center justify-between">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400">{formatTime(notification.createdAt)}</p>
                      </div>
